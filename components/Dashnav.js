...
import { CalendarIcon, HomeIcon, SearchCircleIcon, UserGroupIcon } from "@heroicons/react/outline";
        ...
        <ul>
          ...
          <li className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
            <button
              ...
              name="sponsor"
              onClick={openModal}>
              <SearchCircleIcon className="-ml-1 mr-2 h-5 w-5 text-gray-400" aria-hidden="true" />
          ...
          <li className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
            <button
              ...
              name="grow"
              onClick={openModal}>
              <UserGroupIcon className="-ml-1 mr-2 h-5 w-5 text-gray-400" aria-hidden="true" />
